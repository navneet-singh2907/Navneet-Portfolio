  ...
  return (
    <section id="projects" className="page-section solid">
      ...
      <div className="projects-grid">
        {PROJECTS.map(p => p.type === 'contribution' ? (
          <div key={p.title} className="project-card project-contribution">
            ...
            <h3 className="contrib-title">{p.title}</h3>
            <p className="contrib-desc">{p.desc}</p>
            <div className="project-tags">
              {p.tags.map(t => <span key={t} className="project-tag">{t}</span>)}
            </div>
            <hr className="contrib-divider" />
            <div className="contrib-footer">
              <a href={p.code} target="_blank" rel="noreferrer" className="contrib-link">
              ...
              <span className="contrib-date">{p.date}</span>
            </div>
          </div>
        ) : (
