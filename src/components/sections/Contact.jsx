    ...
    <section id="contact" className="page-section solid">
      ...
      <div className="contact-layout">
        <form
          ...
          action="https://formspree.io/f/xgvgrvwr"
          method="POST"
        >
          ...
          <div className="form-group">
            ...
            <textarea name="message" rows={5} placeholder="What do you want to say?" required />
          </div>
          <button type="submit" className="btn-primary">Send</button>
        </form>
        <div className="contact-social">
          <p className="contact-reach">Or reach me directly</p>
          <div className="social-links">
            <a href="https://github.com/navneet-singh2907" target="_blank" rel="noreferrer" className="social-link">
            ...
            <a href="https://www.linkedin.com/in/navneet-singh2907/" target="_blank" rel="noreferrer" className="social-link">
              <svg viewBox="0 0 24 24" width="22" height="22" fill="currentColor">
